...
#——————–——session—————————#
bot = telebot.TeleBot('6790525746:AAHlwbDzHAKcYzr2CKoj4Lq9uC6wOtwYCyY')
#——–——–—–—BoT_Login———–————#
...
def create_reply_markup(line, work, cents, fucked, All):
    ...
    team_button = telebot.types.InlineKeyboardButton(text="Dev Team", url='https://t.me/eg_sellers')
    dev_button = telebot.types.InlineKeyboardButton(text="Dev", url='https://t.me/ERROR_EMPIRE')
